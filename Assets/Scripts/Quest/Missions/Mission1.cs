...
public class Mission1 
{
    ...
    public readonly static QuestClass[] _mainQuests =
    {
        ...
        new QuestClass (5, "Vá para o pátio!", new DoQuest(), new int[]{ 3 }, "Converse com a aluna Madá no pátio"),
        new QuestClass (12, "Explorar a sala multimeios", new DoQuest(), new int[]{}, "Converse com a Drica na sala multimeios"),
    ...
    public readonly static QuestClass[] _sideQuests =
    {
        ...
        new QuestClass (10410, "Fale com o Jean. (5)", new DoQuest(), new int[]{ 6 }),
